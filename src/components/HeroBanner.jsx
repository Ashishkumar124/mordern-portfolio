...
const HeroBanner = () => {
    ...
    return (
        <div
            id="hero"
            className="w-full h-[50vh] relative bg-[#111111] overflow-hidden md:h-[115vh]"
        >
            ...
            <Wrapper>
                ...
                >
                    <h1 className="text-[50px] md:text-[130px] 2xl:text-[189px] leading-[50px] md:leading-[125px]  2xl:leading-[192px] font-oswald uppercase">
                        I Am A Creative
                ...
                >
                    <div className="font-light mb-4">
                        👋 Hi, I Am{" "}
                        <span className="font-semibold">Ashish Kumar</span>
                    </div>
                    <div className="max-w-[510px]">
                        I create and maintain modern websites and applications.
                        I solve all your business problems. I am passionate about my work.
                    </div>
                </motion.div>
                {/* INTRO END */}
                ...
                {/* PERSON BLOCK START */}
                <motion.div
                    className="w-[300px] md:w-[800px] 2xl:w-[475px] absolute bottom-0 left-[50%] -translate-x-1/2"
                    initial={{ y: 200, x: "-50%" }}
                    animate={{ y: 0 }}
                    transition={{ duration: 0.5 }}
                >
                    <img src={man} alt="" className="md:h-[600px]"/>

                    {/* HIRE ME BUTTON START */}
                    <div
                        className="absolute top-[420px] -right-[-160px] 2xl:top-[240px] 2xl:-right-10 w-[125px] h-[125px] rounded-full bg-white/[0.7] flex flex-col justify-center items-center gap-2 backdrop-blur-sm cursor-pointer transition-transform scale-[0.65] md:scale-100 active:scale-[0.55] md:active:scale-90"
                        onClick={() => scrollTo("contact")}
                    >
                        <img
