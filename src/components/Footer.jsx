            ...
            <Wrapper>
                ...
                <div className="flex flex-col md:flex-row items-center justify-between gap-5 2xl:mt-[63px] relative text-[#111111] border-t border-[#CCCCCC] py-10">
                    <div className="flex items-center gap-[6px]">
                        <div className="w-[40px] h-[40px] rounded-full bg-[#252525] flex justify-center items-center">
                            <img src={gmailIcon} alt="" className="w-[20px]" />
                        </div>
                        <div className="text-[15px]">Ashish@gmail.com</div>
                    </div>
                    <ul className="flex 2xl:text-[20px] gap-5 md:gap-8 text-[15px]">
                        <li
